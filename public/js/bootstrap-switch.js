  ...
  $.fn['bootstrapSwitch'] = function(method) {
    var methods = {
        ...
        return this.each(function() {
            ...
            $element.find('input').on('change', function(e) {
              ...
              if(state === thisState) {
                ...
                if(thisState)
                  $element.removeClass('switch-off').addClass('switch-on'); else $element.removeClass('switch-on').addClass('switch-off');
            ...
            $element.find('label').on('mousedown touchstart', function(e) {
              ...
              if($this.closest('.has-switch').is('.deactivate'))
                ...
                $this.on('click touchend', function(e) {
                  ...
                  if(moving)
                    $myCheckBox.prop('checked', !(parseInt($this.parent().css('left')) < -25)); else $myCheckBox.prop("checked", !$myCheckBox.is(":checked"));
      ...
      setActive: function(active) {
        if(active)
          $(this).removeClass('deactivate'); else $(this).addClass('deactivate');
      },
