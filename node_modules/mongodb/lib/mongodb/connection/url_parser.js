var fs = require('fs'), ReadPreference = require('./read_preference').ReadPreference;
...
exports.parse = function(url, options) {
  ...
  urlOptions.forEach(function(opt) {
    ...
    switch(name) {
      ...
      case 'authMechanism':
        ...
        if(value != 'GSSAPI' && value != 'MONGODB-X509' && value != 'MONGODB-CR' && value != 'PLAIN')
  ...
  if((dbOptions.w == -1 || dbOptions.w == 0) && (
    dbOptions.journal == true || dbOptions.fsync == true || dbOptions.safe == true)) throw new Error("w set to -1 or 0 cannot be combined with safe/w/journal/fsync")
