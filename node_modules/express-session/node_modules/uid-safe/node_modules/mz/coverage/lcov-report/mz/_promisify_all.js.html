...
<div class="header high">
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">mz/</a> &#187; _promisify_all.js
    </div>
</div>
<div class="body">
...
module.exports = function (source, exports, methods) {
  methods.forEach(function (name) {
    <span class="missing-if-branch" title="if path not taken">I</span>if (deprecated(source, name)) <span
