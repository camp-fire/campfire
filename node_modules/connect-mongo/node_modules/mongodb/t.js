...
var mongodb = require('./lib/mongodb'), async = require('async'), ObjectId = mongodb.ObjectID, ReplicaSetManager = require('./test/tools/replica_set_manager').ReplicaSetManager, dbUrl = 'mongodb://127.0.0.1:30000/mydb?replicaSet=rs0', dbOptions = {
    db: {
      w: 1
    },
    server: {
